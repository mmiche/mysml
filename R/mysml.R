#' @title Documentation of this mysml package.
#'
#' @description This is an R package that the package author currently considers useful for applying supervised machine learning.
#' @aliases mysml-package
"_PACKAGE"
#'
